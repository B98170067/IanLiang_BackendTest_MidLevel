...
namespace backend_interview_mid.Contexts;

public partial class BackendExamHubDbContext : DbContext
{
    public BackendExamHubDbContext(DbContextOptions<BackendExamHubDbContext> options)
        : base(options)
    {
    }
